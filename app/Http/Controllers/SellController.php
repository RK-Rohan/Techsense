...
class SellController extends Controller
{
    ...
    public function create()
    {
        ...
        $agents = Contact::where('type', 'agent')->get();
        ...
        $terms_condition = TermsCondition::all();
    ...
    public function show($id)
    {
        ...
        $agent_transaction = AgentTransaction::where('invoice_no', $sell->invoice_no)->first();
    ...
    public function edit($id)
    {
        ...
        // Pivot Table stored tc_id as TermsCondition id and transctions_id as Transcition id
        $tcTransactions = TcTransaction::where('transaction_id', $id)->get();
