...
function calculate_billing_details(price_total) {
    ...
    //Add Supplier Amount.
    var supplier_amount = __read_number($('input#supplier_amount'));
    ...
    var total_payable = price_total + order_tax - discount + shipping_charges + packing_charge + additional_expense + supplier_amount;
