$(document).ready(function () {
    ...
    $(document).on('submit', 'form#term_add_form', function (e) {
        e.preventDefault();
        var form = $(this);
        var data = form.serialize();
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.success == true) {
                    $('div.terms_modal').modal('hide');
                    toastr.success(result.msg);
                    if (typeof terms_table !== 'undefined') {
    ...
    $(document).on('click', '.edit_button', function(e) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            success: function(result) {
                $('.edit_terms_modal .modal-content').html(result);
                $('.edit_terms_modal').modal('show');
            },
            error: function() {
    ...
    $(document).on('submit', '#terms_edit_form', function(e) {
        e.preventDefault();
        var form = $(this);
        var data = form.serialize();
