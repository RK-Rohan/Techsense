...
<section class="content">
    ...
    <table class="table table-bordered" id="term_condition_table">
        ...
        <tbody>
            <tr>
                <td>
                    <button type="button" name="add" id="add" class="btn btn-success"><i class='fa fa-plus'></i>Add Line</button>
                </td>
            </tr>
            @foreach($tcTransactions as $tcTransaction)
            <tr>
                <td>
                    <select class="form-control" name="term_select[]">
                        @foreach($termsConditions as $termsCondition)
                            <option value="{{ $termsCondition->id }}" @if($tcTransaction->tc_id == $termsCondition->id) selected @endif>{{ $termsCondition->description }}</option>
                        @endforeach
                    </select>
                </td>
	...
	$(document).ready(function() {
		...
		$('#add').click(function() {
			$('#term_condition_table').append('<tr id="row' +
				'" class="dynamic-added">' +
				'<td><select class="form-control" id="tc_line[]" name="term_select[]">' +
				'@foreach($termsConditions as $tc)<option value="{{$tc->id }}">{{$tc->description }}</option>@endforeach</select></td>' +
