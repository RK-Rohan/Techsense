    ...
    <div class="container">
        ...
        <table class="grid">
            ...
            <tr>
                ...
                <td class="value">{{ $investment->invoice_no ?? '' }}</td>
            </tr>
            <tr>
                <td class="label">Order Amount:</td>
                <td class="value">{{ number_format((float)($investment->amount ?? 0), 2) }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="value">{{ $investment->txn_ref ?? '' }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="value">{{ $investment->received_date ? \Carbon\Carbon::parse($investment->received_date)->format('d-M-Y') : '' }}</td>
            </tr>
            <tr>
                <td class="label">Expected Closing Date:</td>
                <td class="value">{{ $investment->received_date ? \Carbon\Carbon::parse($investment->received_date)->addDays(90)->format('d-M-Y') : '' }}</td>
            </tr>
        </table>
