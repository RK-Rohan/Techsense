...
<div class="row" style="color: #000000 !important;">
	...
	<div class="col-xs-12 text-center">
		<table class="table">
			<tbody>
				<tr>
					<th width="20%" style="border: none;"><img style="max-height: 120px; width: auto;"
							src="{{$receipt_details->logo}}" class="img img-responsive center-block"></th>
		...
		<p style="width: 100% !important" class="word-wrap">
			...
			<span class="pull-right text-left">
				...
				@if($receipt_details->invoice_status == 'quotation')
					...
					<br>
					<strong>Mobile: </strong> {!!$receipt_details->contact_mobile ?? ''!!}
				@endif
			...
			<tbody>
				@forelse($receipt_details->lines as $line)
					<tr>
						...
						<td>@if(!empty($line['product_custom_fields'])) {{$line['product_custom_fields']}} @endif</td>
						<td class="text-right">
...
<div class="row" style="color: #000000 !important;">
	...
	<div class="col-xs-8">
		@if(!empty($receipt_details->total_in_words))
			<strong class="text-capitalize">({{$receipt_details->total_in_words}})</strong>
		@endif
