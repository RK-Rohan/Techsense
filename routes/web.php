...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::resource('agent_transaction', AgentTransactionController::class);
    ...
    Route::get('/contacts/agents', [ContactController::class, 'agentList']);
    Route::post('/contacts/agents/store', [ContactController::class, 'agentStore']);
    ...
    // Route::get('/sells/terms-conditions', 'TermsConditionController@index');
    ...
    Route::get('/reports/bill-due', [ReportController::class, 'getBillDueReport']);
    ...
    Route::get('/reports/sell-payment-method-summary', [ReportController::class, 'sellPaymentMethodWiseSummary']);
    Route::get('/reports/due-payment-received', [ReportController::class, 'duePaymentReceivedReport']);
...
Route::get('sells/download-pdf/{id}', [SellPosController::class, 'downloadQuotation']);

// Route::prefix('terms-conditions')->group(function () {
//     Route::get('/index', [TermsConditionController::class, 'index']);
//     Route::get('/create', [TermsConditionController::class, 'create']);
//     Route::post('/store/{id}', [TermsConditionController::class, 'store']);
// });
